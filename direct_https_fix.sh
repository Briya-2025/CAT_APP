...
# Direct HTTPS Fix - Minimal Changes Only
# This script fixes the specific issues without touching other projects

set -e

echo "🔧 Direct HTTPS Fix for UCA App"
echo "==============================="

# Check if domain is provided
if [ -z "$1" ]; then
    echo "❌ Error: Please provide your domain name"
    echo "Usage: ./direct_https_fix.sh your-domain.com"
    exit 1
fi
...
# Fix 2: Create the missing gunicorn config file
echo "🔧 Creating missing gunicorn configuration..."
...
# Fix 4: Install certbot if not installed
...
# Fix 5: Get SSL certificate
echo "🔐 Obtaining SSL certificate from Let's Encrypt..."
# Stop nginx temporarily
systemctl stop nginx
certbot certonly --standalone -d $DOMAIN -d www.$DOMAIN --email $EMAIL --agree-tos --non-interactive

# Fix 6: Create nginx configuration for UCA App (separate from other projects)
echo "🌐 Creating nginx configuration for UCA App..."
cat > /etc/nginx/sites-available/uca_app_https << EOF
# Nginx configuration for UCA App with SSL support
# This is separate from other projects like shopibiz
...
echo "🔗 Enabling nginx site for UCA App..."
...
echo ""
echo "🎉 Direct HTTPS fix completed!"
echo "============================="
echo ""
echo "📋 Fixed Issues:"
echo "✅ Created matplotlib cache directory with proper permissions"
echo "✅ Created missing gunicorn_uca_app.conf.py file"
echo "✅ SSL certificate obtained from Let's Encrypt"
echo "✅ Nginx configured for HTTPS (separate from other projects)"
...
echo "   sudo nginx -t"
echo ""
echo "⚠️  Note: This configuration is separate from your shopibiz project"
echo "   and won't interfere with your other 5 projects."
